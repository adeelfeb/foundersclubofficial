...
export const foundersClubImages = {
  // Logo (badge) - Navbar & Footer – logo2.png
  ...
  // Practice Areas – local images from temp (square cards on homepage)
  practiceAreas: [
    { image: '/images/corporate-law.avif', title: 'Corporate Law' },
    { image: '/images/family-law.jpg', title: 'Family Law' },
    { image: '/images/immigration.avif', title: 'Immigration' },
    { image: '/images/real-estate.avif', title: 'Real Estate' },
    { image: '/images/wills-and-estates.jpg', title: 'Wills and Estates' },
    { image: '/images/practice-r4.avif', title: 'Dispute Resolution' },
  ],
