...
export const foundersClubImages = {
  ...
  /** Home hero background (layout reference: columns / pillar) */
  homeHeroBg: '/images/hero/pillar.jpg',
  ...
  practiceAreas: [
    {
      image: '/images/hero/timon-studler-ABGaVhJxwDQ-unsplash.jpg',
    ...
    {
      image: '/images/hero/vinayak-sharma-D4H4WYBl1Rs-unsplash.jpg',
      title: 'Immigration',
    ...
    {
      image: '/images/hero/FRONT%20IMAGE.png',
    ...
    {
      image: '/images/hero/our%20services.png',
      title: 'Corporate Law',
    ...
    {
      image: '/images/hero/About%20us%20image.png',
    ...
    {
      image: '/images/hero/contact%20us%20image.png',
