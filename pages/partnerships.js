...
export default function PartnershipsPage() {
  return (
    <>
      <Head>
        <title>Partnerships | Founders Club</title>
        ...
        <main className="pb-0">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pt-8">
            ...
            <section className="mb-20">
              ...
              <p className="text-gold-200/90 font-semibold text-center mb-6">Every potential partner is evaluated for:</p>
